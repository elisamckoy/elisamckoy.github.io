...
namespace UnitTestProject
{
    ...
    public class MedianTests
    {
        ...
        {
            var medianMethod = HelperMethods.getMethod(typeof(MedianClass), "Median");
        ...
        {
            var medianParameterInfo = HelperMethods.getMethodParameters(typeof(MedianClass), "Median");
        ...
        {
            var result = MedianClass.Median(_array1);
        ...
        {
            var result = MedianClass.Median(_array2);
        ...
        {
            var result = MedianClass.Median(_array3);
